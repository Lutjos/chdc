            ...
            <div class="card-body">
                ...
                <div class="">
                    <div id="external-events" class="my-3">
                        ...
                        <div class="external-event" data-class="bg-primary"><i class="fa fa-move"></i>New
                            Theme Release</div>
                        <div class="external-event" data-class="bg-success"><i class="fa fa-move"></i>My
                            Event
                        </div>
                        <div class="external-event" data-class="bg-warning"><i class="fa fa-move"></i>Meet
                            manager</div>
                        <div class="external-event" data-class="bg-dark"><i class="fa fa-move"></i>Create
                            New theme</div>
                    </div>
                    <!-- checkbox -->
                    <div class="pt-3 pb-5 checkbox checkbox-event">
                        <input id="drop-remove" class="styled-checkbox" type="checkbox">
                        <label class="mb-0 ml-2" for="drop-remove">Remove After Drop</label>
                    </div>
